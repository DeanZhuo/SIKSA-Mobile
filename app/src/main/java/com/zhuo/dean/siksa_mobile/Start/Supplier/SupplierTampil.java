...
public class SupplierTampil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder = Helper.loadDialog(SupplierTampil.this);
        ...
        showAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SupplierTampil.this, SupplierTambah.class);
        ...
        jsonObjectCall.enqueue(new Callback<List<Supplier>>() {
            ...
            public void onResponse(Call<List<Supplier>> call, Response<List<Supplier>> response) {
                ...
                if(response.body() != null){
                    ...
                    try {
                        Log.d("supplier", "onResponse: "+response.errorBody().string());
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }
                adapter = new SupplierAdapter(SupplierTampil.this, supplierList);
                listView.setAdapter(adapter);
                Toast.makeText(SupplierTampil.this, "Success", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onFailure(Call<List<Supplier>> call, Throwable t) {
                Toast.makeText(SupplierTampil.this, "Network Connection Error", Toast.LENGTH_SHORT).show();

                if (t instanceof IOException) {
                    Toast.makeText(SupplierTampil.this, "this is an actual network failure :( inform the user and possibly retry", Toast.LENGTH_SHORT).show();
                    // logging probably not necessary
                }
                else {
                    Toast.makeText(SupplierTampil.this, "conversion issue! big problems :( ", Toast.LENGTH_SHORT).show();
